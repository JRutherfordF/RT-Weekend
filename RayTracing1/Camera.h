...
public:
	...
	int image_width			= 10;	// Rendered image width in pixel count
...
private:
	...
	ray get_ray(int i, int j) const {
		// Construct a camera ray originating form the origin and directed at randomly sampled point around the pixel location i, j
